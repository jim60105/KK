...
namespace KK_Sample.StringResources {
    internal static class StringResourcesManager {
        public static CultureInfo UICulture { get; private set; }
        private static readonly ManualLogSource Logger = KK_Sample.Logger;
        ...
        internal static string GetString(string str, string lang = "") {
            ...
            if (string.IsNullOrEmpty(str))
                Logger.LogInfo("Empty language query string");
            ...
            if (null == stream) {
                ...
                if (lang != "en") {
                    Logger.LogDebug($"Language {lang} not found! Load English for default.");
                }
            }
